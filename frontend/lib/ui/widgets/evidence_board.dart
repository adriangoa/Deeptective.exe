          ...
          children: [
            ...
            Positioned(
              ...
              child: Transform.rotate(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: const Color(0xFFFDFBF7), // Blanco papel viejo
                    boxShadow: [
                      BoxShadow(
...
class _EvidenceModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Color(0xFF1A1A1A), // Fondo oscuro (Mesa)
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFFDFBF7), // Papel
                borderRadius: BorderRadius.circular(4),
                boxShadow: [
                  BoxShadow(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'CASE FILE: ${report.tags.firstOrNull?.toUpperCase() ?? "UNK"}',
                              style: const TextStyle(
                                fontFamily: 'Courier',
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
...
## ANALYSIS
**Source Reliability:** ${report.evidenceLevel}
**Keywords:** ${report.tags.join(', ')}

---
*Generated by Deeptective Neural Net*
""",
